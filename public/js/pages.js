...
function integrate() {
	...
	let tiles = document.querySelector('.ei-editable-sortable-tiles.author-tiles .tiles')
	if (tiles) {
...
async function appSetup() {
	...
	let pics = document.querySelectorAll('.author-fields-form input[type="text"].picture-input-field')
	for(let pic of pics) {
